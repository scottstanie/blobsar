...
def get_log(
    name: str = "blobsar._log", debug: bool = False, filename: Optional[str] = None
) -> logging.Logger:
...
def setup_logging(debug: bool = False) -> None:
    ...
    """
    # Set for all blobsar modules
    logger = logging.getLogger("blobsar")
